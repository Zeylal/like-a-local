...
// URL slug (e.g. milano-2026.md -> /trips/milano-2026/). All page content
// (facts, day-by-day, food, tips, the trip's own route map, the city intro)
// lives in frontmatter here; the markdown body itself is unused.
